...
class Menu:
    ...
    def create_buttons(self):
        ...
        self.buttons.append(Button('Jouer', start_x, start_y, self.assets.bouton_jouer, self.assets.bouton_jouer_click, lambda: self.change_menu_callback("win_step"), self.assets, self.assets.color_theme))
