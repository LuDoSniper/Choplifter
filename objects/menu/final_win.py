...
class FinalWin:
    ...
    def draw(self):
        ...
        game_over_text = self.assets.get_custom_font(32).render("THE END !", True, self.assets.GRIS_FONCE)
    ...
    def create_buttons(self):
        ...
        self.buttons.append(Button('CREDITS', start_x, start_y, self.assets.bouton, self.assets.bouton_click, lambda: self.change_menu_callback("credits"), self.assets))
        self.buttons.append(Button('Discord', start_x, start_y + button_height + spacing, self.assets.bouton, self.assets.bouton_click, self.get_discord, self.assets))
