...
class MenuPause:
    ...
    def create_buttons(self):
        ...
        self.buttons.append(Button('BUREAU', start_x, start_y + 3 * (button_height + spacing), self.assets.bouton_jouer, self.assets.bouton_jouer_click, self.quit_game,self.assets, self.assets.JAUNE))
